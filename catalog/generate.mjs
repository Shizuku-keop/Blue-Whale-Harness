...
.banner-img{padding:10px 20px;border-bottom:1px solid var(--bd)}
.banner-img img{max-width:100%;max-height:220px;height:auto;display:block;margin:0 auto;border-radius:6px}
`
...
function htmlDoc(UI, intentKey, extraCols) {
  ...
  return '<!doctype html>\n'
    ...
    + '</style></head>\n'
    + THEME_HEAD
    + '<body>\n<header>\n<h1>' + UI.title + '</h1>\n<div class="repo-link"><a href="' + REPO_URL + '" target="_blank" rel="noopener">📦 源码仓库 · Blue-Whale-Harness</a> ｜ 🛒 <a href="https://aivps.github.io/" target="_blank" rel="noopener">买AI，买VPS都上 AIVPS开源采购网</a></div>\n<div class="bar">\n'
    ...
    + '<div class="banner-img"><img src="https://leenkcool.github.io/pindaoh.png" alt="频道"></div>\n'
